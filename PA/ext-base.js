...
(function () {
    var g = 0, s = Object.prototype.toString, t = navigator.userAgent.toLowerCase(), y = function (e) {
            return e.test(t)
        }, i = document, l = i.compatMode == "CSS1Compat", A = y(/opera/), h = y(/\bchrome\b/), u = y(/webkit/),
        x = !h && y(/safari/), f = x && y(/applewebkit\/4/), b = x && y(/version\/3/), B = x && y(/version\/4/),
        r = !A && y(/msie/), p = r && y(/msie 7/), o = r && y(/msie 8/), q = r && !p && !o, n = !u && y(/gecko/),
        d = n && y(/rv:1\.8/), a = n && y(/rv:1\.9/), v = r && !l, z = y(/windows|win32/), k = y(/macintosh|mac os x/),
        j = y(/adobeair/), m = y(/linux/), c = /^https/i.test(window.location.protocol);
    if (q) {
        try {
    ...
    Ext.apply(Ext, {
        ...
        urlEncode: function (G, F) {
            ...
            Ext.iterate(G, function (e, H) {
                ...
                Ext.each(D ? e : H, function (I) {
                    C.push("&", E(e), "=", (!Ext.isEmpty(I) && (I != e || !D)) ? (Ext.isDate(I) ? Ext.encode(I).replace(/"/g, "") : E(I)) : "")
                })
            });
            if (!F) {
                C.shift();
        ...
        getDom: function (D, C) {
            ...
            if (D.dom) {
                ...
                if (Ext.isString(D)) {
                    var E = i.getElementById(D);
                    if (E && r && C) {
                        if (D == E.getAttribute("id")) {
                            return E
                        } else {
                            return null
                        }
        ...
        removeNode: r && !o ? function () {
            ...
            return function (C) {
                if (C && C.tagName != "BODY") {
                    (Ext.enableNestedListenerRemoval) ? Ext.EventManager.purgeElement(C, true) : Ext.EventManager.removeAll(C);
        ...
        isEmpty: function (C, e) {
            return C === null || C === undefined || ((Ext.isArray(C) && !C.length)) || (!e ? C === "" : false)
        },
        isArray: function (e) {
...
Ext.apply(Ext, function () {
    ...
    return {
        ...
        BLANK_IMAGE_URL: Ext.isIE6 || Ext.isIE7 || Ext.isAir ? "http://extjs.com/s.gif" : "data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==",
        ...
        num: function (e, d) {
            e = Number(Ext.isEmpty(e) || Ext.isArray(e) || Ext.isBoolean(e) || (Ext.isString(e) && e.trim().length == 0) ? NaN : e);
            return isNaN(e) ? d : e
        },
        ...
        getScrollBarWidth: function (f) {
            ...
            if (f === true || b === null) {
                var h = Ext.getBody().createChild('<div class="x-hide-offsets" style="width:100px;height:50px;overflow:hidden;"><div style="height:200px;"></div></div>'),
                    g = h.child("div", true);
                var e = g.offsetWidth;
...
(function () {
    ...
    (function () {
        ...
        Ext.lib.Dom = {
            isAncestor: function (j, k) {
                ...
                var j, q, s, v, l, m, u = 0, r = 0, t, i, n = (g.body || g.documentElement), o = [0, 0];
                k = Ext.getDom(k);
                if (k != n) {
    ...
    Ext.lib.Event = function () {
        var w = false, g = {}, A = 0, p = [], d, C = false, k = window, G = document, l = 200, s = 20, B = 0, r = 0,
            i = 1, m = 2, t = 2, x = 3, u = "scrollLeft", q = "scrollTop", f = "unload", z = "mouseover",
            F = "mouseout", e = function () {
                var H;
                if (k.addEventListener) {
                    H = function (L, J, K, I) {
                        if (J == "mouseenter") {
                            K = K.createInterceptor(o);
        ...
        function o(H) {
            return !v(H.currentTarget, y.getRelatedTarget(H))
        }
        ...
        function D() {
            var J = false, N = [], L, K, H, I, M = !w || (A > 0);
            if (!C) {
                C = true;
                for (K = 0, H = p.length; K < H; K++) {
                    I = p[K];
                    if (I && (L = G.getElementById(I.id))) {
                        if (!I.checkReady || w || L.nextSibling || (G && G.body)) {
                            L = I.override ? (I.override === true ? I.obj : I.override) : L;
                            I.fn.call(L, I.obj);
                            p.remove(I)
                        } else {
                            N.push(I)
        ...
        function E() {
            var H = G.documentElement, I = G.body;
            if (H && (H[q] || H[u])) {
                return [H[u], H[q]]
            } else {
                if (I) {
        ...
        var y = {
            extAdapter: true, onAvailable: function (J, H, K, I) {
                p.push({id: J, fn: H, obj: K, override: I, checkReady: false});
                A = l;
                n()
            }, addListener: function (J, H, I) {
                J = Ext.getDom(J);
                if (J && I) {
                    if (H == f) {
                        if (g[J.id] === undefined) {
                ...
                if (N && M) {
                    if (J == f) {
                        if ((K = g[N.id]) !== undefined) {
                            for (L = 0, I = K.length; L < I; L++) {
                                if ((H = K[L]) && H[r] == J && H[i] == M) {
                                    g[N.id].splice(L, 1)
                                }
                            }
                        }
                ...
                if (H == "[xpconnect wrapped native prototype]" || H == "[object XULElement]") {
                    return
                }
                return I.nodeType == 3 ? I.parentNode : I
            } : function (H) {
                return H && H.nodeType == 3 ? H.parentNode : H
            }, getRelatedTarget: function (H) {
                H = H.browserEvent || H;
                ...
                return [this.getPageX(H), this.getPageY(H)]
            }, stopEvent: function (H) {
                this.stopPropagation(H);
                ...
                H = H || k.event;
                if (!H) {
                    var I = this.getEvent.caller;
                    while (I) {
                        H = I.arguments[0];
                        if (H && Event == H.constructor) {
                            break
                        }
                        I = I.caller
                    }
            ...
            }, getListeners: function (I, H) {
                Ext.EventManager.getListeners(I, H)
            }, purgeElement: function (I, J, H) {
                Ext.EventManager.purgeElement(I, J, H)
            }, _load: function (I) {
                w = true;
                var H = Ext.lib.Event;
                if (Ext.isIE && I !== true) {
                ...
                var I = Ext.lib.Event, L, K, J, R, P, H, N, M, S;
                for (H in g) {
                    P = g[H];
    ...
    Ext.lib.Ajax = function () {
        ...
        function o(q, w) {
            var A = {}, v, u = q.conn, y, z, r = u.status == 1223;
            try {
                v = q.conn.getAllResponseHeaders();
                Ext.each(v.replace(/\r\n/g, "\n").split("\n"), function (s) {
                    y = s.indexOf(":");
                    if (y >= 0) {
                        z = s.substr(0, y).toLowerCase();
                        if (s.charAt(y + 1) == " ") {
                            ++y
                        }
                        A[z] = s.substr(y + 1)
            ...
            return {
                tId: q.tId,
                status: r ? 204 : u.status,
                statusText: r ? "No Content" : u.statusText,
        ...
        var k = {
            ...
            serializeForm: function (r) {
                var s = r.elements || (document.forms[r] || Ext.getDom(r)).elements, y = false, x = encodeURIComponent,
                    v, z, q, t, u = "", w;
                    ...
                    if (!A.disabled && q) {
                        if (/select-(one|multiple)/i.test(w)) {
                            Ext.each(A.options, function (B) {
                                if (B.selected) {
                                    u += String.format("{0}={1}&", x(q), x((B.hasAttribute ? B.hasAttribute("value") : B.getAttribute("value") !== null) ? B.value : B.text))
                                }
                            })
                        } else {
    ...
    Ext.lib.Region.prototype = {
        contains: function (e) {
            ...
            var h = this, f = Math.max(h.top, i.top), g = Math.min(h.right, i.right), d = Math.min(h.bottom, i.bottom),
                e = Math.max(h.left, i.left);
            if (d >= f && g >= e) {
                return new Ext.lib.Region(f, g, d, e)
            }
        }, union: function (i) {
            var h = this, f = Math.min(h.top, i.top), g = Math.max(h.right, i.right), d = Math.max(h.bottom, i.bottom),
    ...
    (function () {
        var g = Ext.lib, i = /width|height|opacity|padding/i, f = /^((width|height)|(top|left))$/,
            d = /width|height|top$|bottom$|left$|right$/i, h = /\d+(em|%|en|ex|pt|in|cm|mm|pc)$/i, j = function (k) {
        ...
        g.AnimBase.prototype = {
            doMethod: function (k, n, l) {
                ...
                var r = this, s = this.attributes[p], t = s.to, q = s.by, u = s.from, v = s.unit,
                    l = (this.runAttrs[p] = {}), m;
                if (!j(t) && !j(q)) {
                    return false
                }
        ...
        Ext.lib.AnimMgr = new function () {
            ...
            var n = function (r) {
                var v = r.totalFrames, u = r.curFrame, t = r.duration, s = (u * t * 1000 / v), q = (e() - r.startTime),
                    w = 0;
                if (q < t * 1000) {
        ...
        (function () {
            ...
            Ext.apply(g.Motion.prototype, {
                setAttr: function (o, s, r) {
                    ...
                    if (l.test(v)) {
                        var x = this, q = this.el, A = this.attributes.points, t = A.control || [], y = A.from,
                            z = A.to, w = A.by, B = g.Dom, p, s, r, u, o;
    ...
    (function () {
        ...
        var j = h.ColorAnim.superclass, i = /color$/i, f = /^transparent|rgba\(0, 0, 0, 0\)$/,
            l = /^rgb\(([0-9]+)\s*,\s*([0-9]+)\s*,\s*([0-9]+)\)$/i, d = /^#?([0-9A-F]{2})([0-9A-F]{2})([0-9A-F]{2})$/i,
            e = /^#?([0-9A-F]{1})([0-9A-F]{1})([0-9A-F]{1})$/i, g = function (m) {
